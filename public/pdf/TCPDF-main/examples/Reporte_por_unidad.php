...
$pdf->Cell(25, 5, $unidad->id_unidad, 1);
$pdf->Cell(25, 5, $unidad->tipo, 1);
$pdf->Cell(20, 5, $unidad->anio_unidad, 1);
$pdf->Cell(30, 5, $unidad->marca, 1);
$pdf->Cell(20, 5, $unidad->estado, 1, 1); 
$pdf->Ln(10); // Salto de línea antes de la tabla
