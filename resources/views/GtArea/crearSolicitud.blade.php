...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                ...
                <table class="table table-bordered" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>
                                <form action="{{ route('eliminarElementoDir', ['index' => $index]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('editArrayDir', ['index' => $index]) }}" method="post">
                                            @csrf
            ...
            <form action="{{route('arraySoliDir')}}" method="post">
                @csrf
                <div class="form-group">
        ...
        <div class="card-footer py-3">
            <form action="{{route('requisicionDir')}}" method="post">
                @csrf
