    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <a class="m-0 btn btn-primary" href="{{ route('crearPagosDir') }}">Crear solicitud de pago</a>
                <div class="form-group d-flex align-items-center">
                    <a class="btn btn-warning" data-toggle="modal" data-target="#Servicios">
                        Consultar servicios
                    </a>
                    <div class="modal fade" id="Servicios" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                                                ...
                                                @foreach ($servicios as $servicio)
                                                    <tr>
                                                        ...
                                                        <th>
                                                            ...
                                                            <a class="btn btn-success btn-editar" href="#"
                                                                data-toggle="modal"
                                                                data-target="#editarServ{{ $servicio->id_servicio }}">
                                                                Editar
                                                            </a>
                                                            <!-- Logout Modal-->
                                                            <div class="modal fade"
                                                                id="editarServ{{ $servicio->id_servicio }}" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form
                                                                                action="{{ route('editServicio', $servicio->id_servicio) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                {!! method_field('PUT') !!}
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input name="nombre"
                                                                                        ...
                                                                                        placeholder="Nombre del servicio a registrar"
                                                                                        required>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="exampleFormControlInput1">Proveedor:</label>
                                                                                    <select name="proveedor"
                                                                                        class="form-control" id=""
                                                                                        required>
                                                                                        <option
                                                                                            value="{{ $servicio->id_proveedor }}">
                                                            ...
                                                            <a class="btn btn-danger" href="#" data-toggle="modal"
                                                                data-target="#eliminarServ{{ $servicio->id_servicio }}">
                                                                Eliminar
                                                            </a>
                                                            <!-- Logout Modal-->
                                                            <div class="modal fade"
                                                                id="eliminarServ{{ $servicio->id_servicio }}"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel">
                                                                                ¿Ha tomado una decisión?</h5>
                                                                            <button class="close" type="button"
                                                                                data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">X</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">Selecciona confirmar para
                                                                            eliminar este servicio</div>
                                                                        <div class="modal-footer">
                                                                            <button class="btn btn-secondary" type="button"
                                                                                data-dismiss="modal">cancelar</button>
                                                                            <form
                                                                                action="{{ route('deleteServicio', $servicio->id_servicio) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">
                                        <a href="{{ asset($pago->pdf) }}" target="_blank">
                                            <img class="imagen-container" src="{{ asset('img/pago.jpg') }}"
                                                alt="Abrir PDF">
                                        </a>
                                    </th>
                                    <th>
                                        ...
                                        @else
                                            ...
                                            <div class="modal fade" id="EditarPago{{ $pago->id_pago }}" tabindex="1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('updatePagoDir', $pago->id_pago) }}"
                                                                method="post">
                                                                @csrf
                                                                {!! method_field('PUT') !!}
                                                                <div class="form-group">
                                            ...
                                            <!-- Logout Modal-->
                                            <div class="modal fade" id="EliminarPago{{ $pago->id_pago }}" tabindex="-1"
                                                role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">¿Ha tomado
                                                                una decisión?</h5>
                                                            <button class="close" type="button" data-dismiss="modal"
                                                                aria-label="Close">
                                                                <span aria-hidden="true">X</span>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-secondary" type="button"
                                                                data-dismiss="modal">cancelar</button>
                                                            <form action="{{ route('deletePagoDir', $pago->id_pago) }}"
                                                                method="POST">
                                                                @csrf
                                                                {!! method_field('PUT') !!}
                                                                <button type="submit"
