    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('index')}}">
                ...
                <div class="sidebar-brand-text mx-3">VAM'S <sup>ALMACEN</sup></div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="{{route('indexAlm')}}">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('requisicionesAlm')}}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Solicitudes</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="{{route('entradasAlm')}}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Entradas</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="{{route('almacenAlm')}}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Almacen</span></a>
            </li>
