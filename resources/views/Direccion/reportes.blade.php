                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <a class="btn btn-primary" href="{{route('reporteGeneral')}}">Crear reporte</a>                                
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <form action="{{route('reporteEncargado')}}" method="POST">
                                @csrf
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <form action="{{route('reporteUnidad')}}" method="POST">
                                @csrf
                                <div class="form-group">
