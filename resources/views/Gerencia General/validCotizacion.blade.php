                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{route('selectCotizaF',['id' => $cotizacion->id_cotizacion, 'sid' => $cotizacion->requisicion_id])}}" method="POST">
                                                    @csrf
                                                    {!!method_field('PUT')!!}
                                ...
                                aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button class="btn btn-secondary" type="button" data-dismiss="modal">cancelar</button>
                                                <form action="{{route('deleteCotizacionF',['id' => $cotizacion->id_cotizacion, 'rid' => $cotizacion->requisicion_id])}}" method="POST">
                                                    @csrf
                                                    {!!method_field('DELETE')!!}
                                                    <button type="submit" class="btn btn-primary">confirmar</button>
                                                </form>
