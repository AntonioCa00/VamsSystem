                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <div>
                                        <label for="exampleFormControlSelect1">ORDENES DE COMPRA - REQUISICIONES: </label>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('reporteOCConta') }}" method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal fade" id="ReportesPagos" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('reporteOPConta') }}" method="POST">
                                                            @csrf
                                                            <div class="card-body py-1">
                                                                <div class="row">
                                                                    <div class="col-sm-6 mb-1">
